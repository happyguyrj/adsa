 ...
 public:
  ...
  DirectedGraph  ::DirectedGraph(int numVertices, char mode){
    if(mode=='m'){
      ...
      graphlistist.resAdjacencyList(numVertices);
    }
    mode = mode;
  }
  ...
  int DirectedGraph  ::indegree(int i){
    if(mode=='m'){
      ...
      return graphlistist.indegree(i);
    }
  }
  ...
  int DirectedGraph  ::outdegree(int i){
    if(mode=='m'){
      ...
      return graphlistist.outdegree(i);
    }
  }
  ...
  void DirectedGraph  ::edgeExists(int i, int j){
    if(mode=='m'){
      ...
      return graphlistist.edgeExists(i,j);
    }
  }
